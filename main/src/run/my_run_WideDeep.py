...
commend_list=['python','main.py', '--model_name', 'WideDeep', '--dataset', 'KuaiRand_history'
...
def run_WideDeep_ImmersRec(script_content):
...
script_content = run_WideDeep_ImmersRec(script_content)


with open('run_Kuai_WideDeep_ImmersRec.sh','w') as f:
