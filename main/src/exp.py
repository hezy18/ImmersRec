...
def parse_args():
    ...
    parser.add_argument('--cmd_dir', nargs='?', default='./',
                        help='Command dir.')
    parser.add_argument('--in_f', nargs='?', default='run_test.sh',
                        help='Input commands.')
    parser.add_argument('--out_f', nargs='?', default='exp_test.csv',
                        help='Output csv.')
...
def main():
    args = parse_args()
    columns = ['Model', 'Test', 'BestIter', 'Time', 'Seed', 'Run CMD']
    skip = args.skip
